...
- Enabled marketplaces: **192**
- Discoverable plugins: **2,529**
- Healthy repos: **167** · Unavailable: **25**
- Last updated: **2026-06-24 19:53 UTC**
...
| [aaron-he-zhu/seo-geo-claude-skills](https://github.com/aaron-he-zhu/seo-geo-claude-skills) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) | 78 | `main` | `.claude-plugin` | ✅ ok |  |
| [alo-exp/silver-bullet](https://github.com/alo-exp/silver-bullet) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [bendrucker/claude](https://github.com/bendrucker/claude) | 30 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [ccplugins/awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins) | 118 | `main` | `.claude-plugin` | ✅ ok |  |
| [cdeust/zetetic-team-subagents](https://github.com/cdeust/zetetic-team-subagents) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [codearranger/claude-legal](https://github.com/codearranger/claude-legal) | 14 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [davepoon/buildwithclaude](https://github.com/davepoon/buildwithclaude) | 73 | `main` | `.claude-plugin` | ✅ ok |  |
| [daymade/claude-code-skills](https://github.com/daymade/claude-code-skills) | 48 | `main` | `.claude-plugin` | ✅ ok |  |
| [deanpeters/Product-Manager-Skills](https://github.com/deanpeters/Product-Manager-Skills) | 47 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [dvcdsys/code-index](https://github.com/dvcdsys/code-index) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [fakoli/fakoli-plugins](https://github.com/fakoli/fakoli-plugins) | 16 | `main` | `.claude-plugin` | ✅ ok |  |
| [feiskyer/claude-code-settings](https://github.com/feiskyer/claude-code-settings) | 7 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [gtapps/claude-code-hermit](https://github.com/gtapps/claude-code-hermit) | 6 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [jabrena/cursor-rules-java](https://github.com/jabrena/cursor-rules-java) | 63 | `main` | `.claude-plugin` | ✅ ok |  |
| [jeremylongshore/claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus) | 451 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [jmagar/unraid-mcp](https://github.com/jmagar/unraid-mcp) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
| [joaquimscosta/arkhe-claude-plugins](https://github.com/joaquimscosta/arkhe-claude-plugins) | 14 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [Klotzkette/claude-fuer-deutsches-recht](https://github.com/Klotzkette/claude-fuer-deutsches-recht) | 232 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [Lifecycle-Innovations-Limited/claude-ops](https://github.com/Lifecycle-Innovations-Limited/claude-ops) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [modu-ai/cowork-plugins](https://github.com/modu-ai/cowork-plugins) | 28 | `main` | `.claude-plugin` | ✅ ok |  |
| [mohitagw15856/pm-claude-skills](https://github.com/mohitagw15856/pm-claude-skills) | 32 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [netresearch/claude-code-marketplace](https://github.com/netresearch/claude-code-marketplace) | 42 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [oliver-kriska/claude-elixir-phoenix](https://github.com/oliver-kriska/claude-elixir-phoenix) | 2 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [Piebald-AI/claude-code-lsps](https://github.com/Piebald-AI/claude-code-lsps) | 35 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [RadOrigin-LLC/RAD-Claude-Skills](https://github.com/RadOrigin-LLC/RAD-Claude-Skills) | 13 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [saadshahd/moo.md](https://github.com/saadshahd/moo.md) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [secondsky/sap-skills](https://github.com/secondsky/sap-skills) | 37 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [sitemd-cc/sitemd](https://github.com/sitemd-cc/sitemd) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
| [Smart-AI-Memory/attune-ai](https://github.com/Smart-AI-Memory/attune-ai) | 4 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [testdouble/han](https://github.com/testdouble/han) | 10 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [voxpelli/vp-claude](https://github.com/voxpelli/vp-claude) | 3 | `main` | `.claude-plugin` | ✅ ok |  |
| [wondelai/skills](https://github.com/wondelai/skills) | 9 | `main` | `.claude-plugin` | ✅ ok |  |
| [worldwonderer/oh-story-claudecode](https://github.com/worldwonderer/oh-story-claudecode) | 13 | `main` | `.claude-plugin` | ✅ ok |  |
| [wshobson/agents](https://github.com/wshobson/agents) | 84 | `main` | `.claude-plugin` | ✅ ok |  |
| [wyre-technology/msp-claude-plugins](https://github.com/wyre-technology/msp-claude-plugins) | 60 | `main` | `.claude-plugin` | ✅ ok |  |
...
| [zapier/zapier-mcp](https://github.com/zapier/zapier-mcp) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
| [zarazhangrui/frontend-slides](https://github.com/zarazhangrui/frontend-slides) | 1 | `main` | `.claude-plugin` | ✅ ok |  |
| [7xuanlu/wenlan](https://github.com/7xuanlu/wenlan) | 0 | `main` | `.claude-plugin` | ❌ missing | HTTP 404; marketplace.json not found |
...
| [ggrigo/align](https://github.com/ggrigo/align) | 0 | `main` | `.claude-plugin` | ❌ missing | HTTP 404; marketplace.json not found |
...
| [NickFlach/kannaka-plugin](https://github.com/NickFlach/kannaka-plugin) | 0 | `main` | `.claude-plugin` | ❌ missing | HTTP 404; marketplace.json not found |
