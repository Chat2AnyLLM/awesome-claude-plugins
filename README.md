...
Last updated: 2026-06-16 11:21 UTC
...
| [dos-kernel](https://github.com/anthony-chaudhary/dos-kernel/tree/master/claude-plugin) | dos-kernel | Bundles the DOS hooks + MCP server + the generic skill pack into one install. Requires the dos-kernel Python package (pip install 'dos-kernel[mcp]'). | Anthony Chaudhary | 0.27.0 |
