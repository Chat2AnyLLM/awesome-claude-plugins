...
Total Marketplaces: 88 | Total Plugins: 1273

Last updated: 2026-06-19 09:47 UTC
...
| [NotFair](https://github.com/nowork-studio/NotFair) | nowork-studio | Open-source Claude Code skills for SEO, GEO, Google Ads, and Meta Ads — connects to live data via Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP. | nowork-studio | 1.0.0 |
