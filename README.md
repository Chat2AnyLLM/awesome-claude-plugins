...
Last updated: 2026-06-06 04:57 UTC
...
| [geepers](https://dr.eamer.dev/geepers/) | claude-code-plugins-plus | Multi-agent orchestration system with 51 specialized agents for development workflows, code quality, deployment, research, and more. Built with MCP... | Luke Steuber | 1.0.0 |
...
| [ui-design](https://github.com/wshobson/agents/blob/main/plugins/ui-design) | claude-code-workflows | Comprehensive UI/UX design plugin for mobile (iOS, Android, React Native) and web applications with design systems, accessibility, and modern patterns | Seth Hobson | 1.0.5 |
...
| [over-50s-health](https://github.com/ali5ter/over-50s-health-advisor) | claude-code-plugins-plus | Evidence-based health, fitness, nutrition, and longevity guidance for adults 50+ | Alister Lewis-Bowen | 3.3.0 |
...
| [ecc](https://github.com/affaan-m/everything-claude-code) | affaan-m/everything-claude-code | Harness-native ECC operator layer - 63 agents, 251 skills, 79 legacy command shims, reusable hooks, rules, selective install profiles, and producti... | Affaan Mustafa | 2.0.0-rc.1 |
