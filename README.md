...
| [memesh](https://github.com/PCIRCLE-AI/claude-code-buddy) | pcircle-ai | Persistent memory for Claude Code with semantic search and knowledge graph. Remembers architecture decisions, coding patterns, and project context across sessions. Automatic capture, project isolation, and 100% local storage. | PCIRCLE AI | 2.8.10 |
