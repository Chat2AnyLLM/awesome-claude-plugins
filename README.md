...
Total Marketplaces: 87 | Total Plugins: 1261

Last updated: 2026-06-16 17:04 UTC
...
| [dos-kernel](https://github.com/anthony-chaudhary/dos-kernel/tree/master/claude-plugin) | dos-kernel | Bundles the DOS hooks + MCP server + the generic skill pack into one install. Requires the dos-kernel Python package (pip install 'dos-kernel[mcp]'). | Anthony Chaudhary | 0.27.1 |
...
| [vibeworkload](https://github.com/3dnow/vibeworkload) | vibeworkload | Render one anonymized PNG showing your Claude Code activity — messages, tool calls, tokens, active hours — over a configurable time window (24h, 7d... | None | 1.0.0 |
