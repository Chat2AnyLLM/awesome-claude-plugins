...
| [credential-guard](https://github.com/yurukusa/cc-safe-setup/tree/main/plugins/credential-guard) | yurukusa/cc-safe-setup | Protect secrets from Claude Code. Blocks writes to .env files, detects API keys in commands, guards service account JSON. From 800+ hours of autonomous operation. | yurukusa | 1.1.0 |
| [git-protection](https://github.com/yurukusa/cc-safe-setup/tree/main/plugins/git-protection) | yurukusa/cc-safe-setup | Git safety hooks: block force-push, protect main/master, prevent hard-reset, guard git clean -fd, block force branch deletion. 5 PreToolUse hooks. | yurukusa | 1.1.0 |
...
| [safety-essentials](https://github.com/yurukusa/cc-safe-setup/tree/main/plugins/safety-essentials) | yurukusa/cc-safe-setup | 5 essential safety hooks: block rm -rf, force-push, hard-reset, .env overwrites, npm publish. Minimum viable safety net from 800+ hours of autonomous operation. | yurukusa | 1.1.0 |
