...
| [the-pragmatic-pm](https://github.com/marfoerst/the-pragmatic-pm) | marfoerst/the-pragmatic-pm | PM leadership toolkit with 43 skills, 5 orchestrator agents, 4 multi-stage workflows, and 4 hooks. Covers PRD generation, OKR lifecycle, pricing, positioning, sales enablement, and quarterly planning. Built on April Dunford, Teresa Torres, Simon-Kucher frameworks. | Martin Foerster | 1.0.0 |
