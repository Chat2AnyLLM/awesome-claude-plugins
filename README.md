...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [agent-sdk-dev](https://github.com/ccplugins/awesome-claude-code-plugins) | awesome-claude-code-plugins | Development kit for working with the Claude Agent SDK | None | 1.0.0 |
| [commit-commands](https://github.com/ccplugins/awesome-claude-code-plugins) | awesome-claude-code-plugins | Commands for git commit workflows including commit, push, and PR creation | Anthropic | 1.0.0 |
...
| [x-bug-triage-plugin](https://github.com/jeremylongshore/claude-code-plugins-plus/blob/main/plugins/mcp/x-bug-triage) | claude-code-plugins-plus | Closed-loop bug triage: X complaints → clusters → repo evidence → owner routing → Slack review → filed issues | Jeremy Longshore | 0.3.0 |
