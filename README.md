...
Last updated: 2026-06-13 18:13 UTC
...
| [claude-mem](https://github.com/thedotmack/claude-mem/tree/main/plugin) | thedotmack | Persistent memory system for Claude Code - context compression across sessions | None | 13.6.0 |
...
| [content-creator](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/content-creator) | cc-marketplace | Content Creator subagent | Michael Galpert | 1.0.0 |
...
| [debugger](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/debugger) | cc-marketplace | Debugging specialist for errors, test failures, and unexpected behavior. Use proactively when encountering any issues. | Anand Tyagi | 1.0.0 |
...
| [frontend-developer](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/frontend-developer) | cc-marketplace | Use this agent when building user interfaces, implementing React/Vue/Angular components, handling state management, or optimizing frontend performa... | Michael Galpert | 1.0.0 |
...
| [legal-compliance-checker](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/legal-compliance-checker) | cc-marketplace | Use this agent when reviewing terms of service, privacy policies, ensuring regulatory compliance, or handling legal requirements. This agent excels... | Michael Galpert | 1.0.0 |
...
| [monitoring-observability-specialist](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/monitoring-observability-specialist) | cc-marketplace | Use this agent when you need to implement comprehensive monitoring, observability, and alerting systems for enterprise B2B applications. This agent... | Alysson Franklin | 1.0.0 |
...
| [project-shipper](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/project-shipper) | cc-marketplace | PROACTIVELY use this agent when approaching launch milestones, release deadlines, or go-to-market activities. This agent specializes in coordinatin... | Michael Galpert | 1.0.0 |
...
| [test-writer-fixer](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/test-writer-fixer) | cc-marketplace | Use this agent when code changes have been made and you need to write new tests, run existing tests, analyze failures, and fix them while maintaini... | Michael Galpert | 1.0.0 |
...
| [visual-storyteller](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/visual-storyteller) | cc-marketplace | Use this agent when creating visual narratives, designing infographics, building presentations, or communicating complex ideas through imagery. Thi... | Michael Galpert | 1.0.0 |
| [web-dev](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/web-dev) | cc-marketplace | Use this agent for expert assistance with web development tasks using React, Next.js, NestJS, and other modern web frameworks with TypeScript and T... | safayavatsal | 1.0.0 |
...
| [machine-learning-ops](https://github.com/wshobson/agents/blob/main/plugins/machine-learning-ops) | claude-code-workflows | ML model training pipelines, hyperparameter tuning, model deployment automation, experiment tracking, and MLOps workflows | Seth Hobson | 1.2.2 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [api-scaffolding](https://github.com/wshobson/agents/blob/main/plugins/api-scaffolding) | claude-code-workflows | REST and GraphQL API scaffolding, framework selection, backend architecture, and API generation | Seth Hobson | 1.2.3 |
...
| [hr-legal-compliance](https://github.com/wshobson/agents/blob/main/plugins/hr-legal-compliance) | claude-code-workflows | HR policy documentation, legal compliance templates (GDPR/SOC2/HIPAA), employment contracts, and regulatory documentation | Seth Hobson | 1.2.3 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [8eyes](https://github.com/AgentBuildersApp/eight-eyes/blob/main/) | AgentBuildersApp/eight-eyes | Multi-agent code review with 8 hook-enforced roles. Parallel audit, TDD mode, custom roles, blind skeptic review. | AgentBuildersApp | 4.2.0 |
...
| [pr-issue-resolve](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/pr-issue-resolve) | cc-marketplace | this is to analyze the PRs and solve the requested changes in them | safayavatsal | 1.0.0 |
...
| [api-contract-sync-manager](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/api-contract-sync-manager) | cc-marketplace | Validate and synchronize API contracts (OpenAPI, GraphQL) with implementation, detect breaking changes, and generate type-safe client code | Claude Code Marketplace | 1.0.0 |
...
| [plugin-dev](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/plugin-dev) | anthropics/claude-plugins-official | Comprehensive toolkit for developing Claude Code plugins. Includes 7 expert skills covering hooks, MCP integration, commands, agents, and best prac... | Anthropic | 1.0.0 |
...
| [serena](https://github.com/anthropics/claude-plugins-official/blob/main/external_plugins/serena) | anthropics/claude-plugins-official | Semantic code analysis MCP server providing intelligent code understanding, refactoring suggestions, and codebase navigation through language serve... | None | 1.0.0 |
...
| [terraform](https://github.com/anthropics/claude-plugins-official/blob/main/external_plugins/terraform) | anthropics/claude-plugins-official | The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infr... | HashiCorp | 1.0.0 |
...
| [documentation-standards](https://github.com/wshobson/agents/blob/main/plugins/documentation-standards) | claude-code-workflows | HADS (Human-AI Document Standard) — semantic tagging convention for writing docs that work efficiently for both humans and AI models. Reduces token... | Niksa Barlovic | 1.0.1 |
...
| [commit](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/commit) | cc-marketplace | Creates git commits using conventional commit format with appropriate emojis, following project standards and creating descriptive messages that ex... | evmts | 1.0.0 |
...
| [create-worktrees](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/create-worktrees) | cc-marketplace | Creates git worktrees for all open PRs or specific branches, handling branches with slashes, cleaning up stale worktrees, and supporting custom bra... | evmts | 1.0.0 |
| [fix-github-issue](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/fix-github-issue) | cc-marketplace | Analyzes and fixes GitHub issues using a structured approach with GitHub CLI for issue details, implementing necessary code changes, running tests,... | jeremymailen | 1.0.0 |
...
| [fix-pr](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/fix-pr) | cc-marketplace | Fetches and fixes unresolved PR comments by automatically retrieving feedback, addressing reviewer concerns, making targeted code improvements, and... | metabase | 1.0.0 |
| [husky](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/husky) | cc-marketplace | Sets up and manages Husky Git hooks by configuring pre-commit hooks, establishing commit message standards, integrating with linting tools, and ens... | evmts | 1.0.0 |
...
| [cloud-infrastructure](https://github.com/wshobson/agents/blob/main/plugins/cloud-infrastructure) | claude-code-workflows | Cloud architecture design for AWS/Azure/GCP/OCI, Kubernetes cluster configuration, Terraform infrastructure-as-code, hybrid cloud networking, and m... | Seth Hobson | 1.3.2 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [arm-cortex-microcontrollers](https://github.com/wshobson/agents/blob/main/plugins/arm-cortex-microcontrollers) | claude-code-workflows | ARM Cortex-M firmware development for Teensy, STM32, nRF52, and SAMD with peripheral drivers and memory safety patterns | Ryan Snodgrass | 1.2.1 |
| [dotnet-contribution](https://github.com/wshobson/agents/blob/main/plugins/dotnet-contribution) | claude-code-workflows | Comprehensive .NET backend development with C#, ASP.NET Core, Entity Framework Core, and Dapper for production-grade applications | Seth Hobson | 1.0.2 |
| [functional-programming](https://github.com/wshobson/agents/blob/main/plugins/functional-programming) | claude-code-workflows | Functional programming with Elixir, OTP patterns, Phoenix framework, and distributed systems | Seth Hobson | 1.2.1 |
...
| [julia-development](https://github.com/wshobson/agents/blob/main/plugins/julia-development) | claude-code-workflows | Modern Julia development with Julia 1.10+, package management, scientific computing, high-performance numerical code, and production best practices | Community Contribution | 1.0.1 |
| [jvm-languages](https://github.com/wshobson/agents/blob/main/plugins/jvm-languages) | claude-code-workflows | JVM language development including Java, Scala, and C# with enterprise patterns and frameworks | Seth Hobson | 1.2.1 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [explanatory-output-style](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/explanatory-output-style) | anthropics/claude-plugins-official | Adds educational insights about implementation choices and codebase patterns (mimics the deprecated Explanatory output style) | Anthropic | 1.0.0 |
...
| [pr-review-toolkit](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/pr-review-toolkit) | anthropics/claude-plugins-official | Comprehensive PR review agents specializing in comments, tests, error handling, type design, code quality, and code simplification | Anthropic | 1.0.0 |
...
| [performance-testing-review](https://github.com/wshobson/agents/blob/main/plugins/performance-testing-review) | claude-code-workflows | Performance analysis, test coverage review, and AI-powered code quality assessment | Seth Hobson | 1.2.2 |
...
| [block-no-verify](https://github.com/wshobson/agents/blob/main/plugins/block-no-verify) | claude-code-workflows | PreToolUse hook that prevents AI agents from using --no-verify, --no-gpg-sign, and other bypass flags that skip git hooks | cskwork | 1.0.1 |
...
| [cli-ux-tester](https://github.com/jeremylongshore/claude-code-plugins-plus/blob/main/plugins/testing/cli-ux-tester) | claude-code-plugins-plus | Expert UX evaluator for CLIs and developer APIs, rates usability across 11 criteria with parallel evaluation agents | Alister Lewis-Bowen | 3.1.0 |
