...
- [claude-code-hooks](https://github.com/yurukusa/claude-code-hooks) - 16 production safety hooks for autonomous Claude Code. Blocks destructive commands, force push, secret leaks, and more. 160+ hours of real operation.
