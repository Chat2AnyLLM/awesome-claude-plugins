...
| [onlyswaps](https://github.com/Delegueinu/onlyswaps/tree/main/packages/mcp-server) | npm | Multi-chain DEX meta-aggregator MCP server that queries 15+ DEX aggregators (0x, 1inch, Paraswap, etc.) and returns the best swap price across 13 chains | OnlySwaps | 0.1.0 |
