...
Total Marketplaces: 87 | Total Plugins: 1271

Last updated: 2026-06-18 05:58 UTC
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [n8n-mcp-skills](https://github.com/czlonkowski/n8n-skills/tree/main/) | czlonkowski/n8n-skills | Complete bundle: 12 expert skills for building flawless n8n workflows using the n8n-mcp MCP server (expression syntax, MCP tools usage, workflow pa... | Romuald Członkowski | 1.17.1 |
...
| [database-migrations](https://github.com/wshobson/agents/blob/main/plugins/database-migrations) | claude-code-workflows | Database migration automation, observability, and cross-database migration strategies | Seth Hobson | 1.2.1 |
...
| [harness-evolver](https://github.com/raphaelchristi/harness-evolver/blob/main/) | raphaelchristi/harness-evolver | Evolves LLM agent code using multi-agent proposers, LangSmith experiments, and git worktrees | Raphael Valdetaro | 6.1.0 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [comprehensive-review](https://github.com/wshobson/agents/blob/main/plugins/comprehensive-review) | claude-code-workflows | Multi-perspective code analysis covering architecture, security, and best practices | Seth Hobson | 1.3.1 |
...
| [security-compliance](https://github.com/wshobson/agents/blob/main/plugins/security-compliance) | claude-code-workflows | SOC2, HIPAA, and GDPR compliance validation, secrets scanning, compliance checklists, and regulatory documentation | Seth Hobson | 1.2.1 |
...
| [git-pr-workflows](https://github.com/wshobson/agents/blob/main/plugins/git-pr-workflows) | claude-code-workflows | Git workflow automation, pull request enhancement, and team onboarding processes | Seth Hobson | 1.3.1 |
